...
public class BoardPanel extends JPanel
{
  ...
  public BoardPanel( int rows, int cols)
  {
    ...
    CELLSIZEX = 280/cols;
    CELLSIZEY = 160/rows;
    setPreferredSize(new Dimension(cols * CELLSIZEX, rows * CELLSIZEY));
  ...
  {
    return new Location(y / CELLSIZEY, x / CELLSIZEX);
  }
  ...
  public void paintComponent(Graphics g)
  {
    ...
    for (int r = 0; r < ROWS; r++)
    {
      for (int c = 0; c < COLS; c++)
      {
        ...
        g.drawRect(x+1, y+1, CELLSIZEX-2, CELLSIZEY-2);
        if (r == 0 && c == 0)
        {
          g.setColor(Color.YELLOW);
          g.drawLine(x+3, y+3, x + CELLSIZEX- 6, y + CELLSIZEY - 6);
          g.drawLine(x+3, y + CELLSIZEY - 6, x + CELLSIZEX - 6, y+3);
        }
      }
    }
